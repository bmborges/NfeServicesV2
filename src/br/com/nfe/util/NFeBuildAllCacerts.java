...
import java.awt.Color;
 ...
 public class NFeBuildAllCacerts {
     ...
     public static void main(String[] args) {
         NFeBuildAllCacerts c = new NFeBuildAllCacerts(null);
         c.GeraCacerts();
     }

    public NFeBuildAllCacerts(br.com.nfe.gui.Painel main) {
        this.main = main;
        
    }

     public void GeraCacerts() {
         try {
             ...
             main.CarregaJtxa(">>> Caminho Arquivo Cacerts: " + caminho, Color.BLACK);
             ...
             main.CarregaJtxa("| Loading KeyStore " + file + "...",Color.BLACK);
...
//             get("hom.sefazvirtual.fazenda.gov.br",443,ks);
             ...
             OutputStream out = new FileOutputStream(caminho + cafile);
